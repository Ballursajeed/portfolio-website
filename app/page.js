      ...
      <div className="container mx-auto h-full">
        ...
        xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none ">
            ...
            <h1 className="h1">
              Hello I'm <br/> <span className="text-accent">Sajeed Balluru</span>
            </h1>
            <p className="mx-w-[500px] mb-9 text-white/80">I excel at crafting elegant digital experiences and I am proficient in 
